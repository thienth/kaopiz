...
-- ----------------------------
BEGIN;
INSERT INTO `products` VALUES (1, 'Stephania Weber', 'https://lorempixel.com/640/480/cats/?19097', 1, 98151, 'Alice felt unhappy. \'It all came into little glass table. \'Nothing WHATEVER?\' persisted the Mock Turtle. \'Very uncomfortable for your interesting dance is only makes people hot-tempered,\' she would.', 'Alice to herself, \'I wonder what they\'ll do well enough; and what does it matter to me whether you\'re a little now and then the Mock Turtle: \'crumbs would all wash off in the chimney as she was.', 3.00, NULL, NULL, 1);
INSERT INTO `products` VALUES (2, 'Maya Goyette', 'https://lorempixel.com/640/480/cats/?59365', 2, 89196, 'Waiting in a pack rose up as if it can\'t think! And he might end, you ever was! Good-bye, feet!\' (for when she could get dry would break. She was rather doubtfully, as before, but she quite a.', 'So Alice got up in spite of all this time. \'I want a clean cup,\' interrupted the Hatter: \'it\'s very easy to take out of its right ear and left foot, so as to prevent its undoing itself,) she carried.', 2.00, NULL, NULL, 1);
INSERT INTO `products` VALUES (3, 'Dr. Erika Balistreri II', 'https://lorempixel.com/640/480/cats/?74265', 6, 48005, 'I don\'t be hungry to himself: \'\"WE KNOW IT TO YOU,\"\' said the fan in despair she must cross-examine the Dormouse. \'Write that it off. The Cat in the pool was now run over; and behind her, one of the.', 'Alice. \'Come on, then,\' said the March Hare, who had been looking over their shoulders, that all the party sat silent for a long silence after this, and Alice joined the procession, wondering very.', 2.00, NULL, NULL, 1);
INSERT INTO `products` VALUES (4, 'Mack Swift', 'https://lorempixel.com/640/480/cats/?16622', 6, 95452, 'How she said, tossing his pocket, and considered a stalk out \'Silence!\' and looking at the baby, and the thimble, saying to pinch it occurred to twist itself upright as follows The players to get.', 'Derision.\' \'I never was so much frightened that she might as well go back, and barking hoarsely all the first day,\' said the Duck: \'it\'s generally a ridge or furrow in the prisoner\'s handwriting?\'.', 1.00, NULL, NULL, 1);
...
INSERT INTO `products` VALUES (20, 'Chanel DuBuque', 'https://lorempixel.com/640/480/cats/?46752', 1, 26422, 'Alice had never saw in the tea--\' \'The Queen! The Hatter\'s remark that a large ring, with the people had just as it would gather about it, that is such a large mushroom (she was gone through into.', 'Elsie, Lacie, and Tillie; and they all moved off, and found in it about four feet high. \'Whoever lives there,\' thought Alice, as she spoke. Alice did not appear, and after a fashion, and this time.', 1.00, NULL, NULL, 1);
INSERT INTO `products` VALUES (21, 'Art Bins', 'https://lorempixel.com/640/480/cats/?81062', 1, 3691, 'They all over with all directions, tumbling up eagerly, half of trouble, you ever see the tiny hands on the table, but she said, \'So they couldn\'t afford to the game.\' The twelve jurors had caught.', 'Gryphon repeated impatiently: \'it begins \"I passed by his garden.\"\' Alice did not dare to laugh; and, as there was a real Turtle.\' These words were followed by a very small cake, on which the words.', 4.00, NULL, NULL, 1);
...
-- ----------------------------
BEGIN;
INSERT INTO `users` VALUES (1, 'thienth', '', 'admin@gmail.com', NULL, 900, '$2y$10$nqckGqzjiEP7BP59WM5oJO6R16EanVVG561vJqxOb6X8WiMo4PJ7K', NULL, NULL, NULL);
INSERT INTO `users` VALUES (2, 'chungcc', '', 'moderator@gmail.com', NULL, 700, '$2y$10$r3Mp1VwBhp/HsxpB3VK8yOtw8FwpGskT4vcpPOf4jiv52xcJfVjwe', NULL, NULL, NULL);
